...
INSERT INTO loyalty_tiers (tier_name, tier_level, min_spending, min_visits, min_points, points_multiplier, benefits, tier_color, tier_icon) VALUES
('Bronze', 1, 0.00, 0, 0, 1.00, '{"free_shipping": false, "priority_support": false, "exclusive_offers": false}', '#CD7F32', 'bronze-medal'),
('Silver', 2, 250.00, 5, 100, 1.25, '{"free_shipping": true, "priority_support": false, "exclusive_offers": true}', '#C0C0C0', 'silver-medal'),
('Gold', 3, 750.00, 15, 500, 1.50, '{"free_shipping": true, "priority_support": true, "exclusive_offers": true, "birthday_bonus": true}', '#FFD700', 'gold-medal'),
('Platinum', 4, 2000.00, 30, 1500, 2.00, '{"free_shipping": true, "priority_support": true, "exclusive_offers": true, "birthday_bonus": true, "personal_concierge": true}', '#E5E4E2', 'crown')
ON CONFLICT (tier_name) DO NOTHING;

-- Insert sample loyalty rewards
INSERT INTO loyalty_rewards (reward_name, reward_type, points_required, discount_percentage, discount_amount, description, terms_conditions) VALUES
('$5 Off Purchase', 'discount', 500, NULL, 5.00, 'Get $5 off your next purchase', 'Valid for 1 year from redemption. Cannot be combined with other offers.'),
('10% Off Purchase', 'discount', 1000, 10.00, NULL, 'Get 10% off your next purchase', 'Valid for 1 year from redemption. Cannot be combined with other offers.'),
('Free Shipping', 'free_shipping', 250, NULL, NULL, 'Free standard shipping on your next order', 'Valid for 1 year from redemption. Standard shipping only.'),
('Birthday Reward', 'birthday', 0, NULL, 10.00, 'Special birthday discount', 'Available during your birthday month. One-time use per year.')
ON CONFLICT DO NOTHING;

-- Insert sample customer addresses for existing customers
INSERT INTO customer_addresses (customer_id, address_type, is_default, first_name, last_name, address_line1, city, state, zip_code, phone, email) VALUES
(1, 'shipping', true, 'John', 'Doe', '123 Main St', 'New York', 'NY', '10001', '555-0123', 'john@email.com'),
(2, 'shipping', true, 'Jane', 'Smith', '456 Oak Ave', 'Los Angeles', 'CA', '90210', '555-0456', 'jane@email.com'),
(3, 'shipping', true, 'Mike', 'Johnson', '789 Pine Rd', 'Chicago', 'IL', '60601', '555-0789', 'mike@email.com'),
(4, 'shipping', true, 'Sarah', 'Wilson', '321 Elm St', 'Houston', 'TX', '77001', '555-0321', 'sarah@email.com')
ON CONFLICT DO NOTHING;

-- Insert sample notification preferences for existing customers
INSERT INTO customer_notification_preferences (customer_id, notification_type, category, is_enabled) VALUES
(1, 'email', 'order_updates', true),
(1, 'email', 'loyalty_rewards', true),
(1, 'email', 'promotions', false),
(2, 'email', 'order_updates', true),
(2, 'email', 'loyalty_rewards', true),
(2, 'email', 'promotions', true),
(3, 'email', 'order_updates', true),
(3, 'email', 'loyalty_rewards', false),
(3, 'email', 'promotions', false),
(4, 'email', 'order_updates', true),
(4, 'email', 'loyalty_rewards', true),
(4, 'email', 'promotions', true)
ON CONFLICT DO NOTHING;
